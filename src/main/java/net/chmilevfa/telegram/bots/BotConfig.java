...
public class BotConfig {
    ...
    private final String freeCurrencyConverterApiKey;
    ...
    public BotConfig(Environment env) {
        ...
        this.freeCurrencyConverterApiKey = env.getProperty("freecurrencyconverter.apiKey");
    }
    ...
    public String getFreeCurrencyConverterApiKey() {
        return freeCurrencyConverterApiKey;
    }
}